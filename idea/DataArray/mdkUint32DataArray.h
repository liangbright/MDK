#ifndef __mdkUint32DataArray_h
#define __mdkUint32DataArray_h
...
class mdkUint32DataArray : public mdkDataArray
{
public:		
	mdkUint32DataArray();
	~mdkUint32DataArray();
...
private:
	mdkUint32DataArray(const mdkUint32DataArray&);        // Not implemented.
	void operator=(const mdkUint32DataArray&);  // Not implemented.

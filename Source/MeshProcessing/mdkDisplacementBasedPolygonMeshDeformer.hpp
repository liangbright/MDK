...
bool DisplacementBasedPolygonMeshDeformer<ScalarType>::CheckInput()
{
	...
	{
		MDK_Error("InputMesh is nullptr @ DisplacementBasedPolygonMeshDeformer::CheckInput()")
		return false;
	}

	if (Input.SourceMesh->IsEmpty() == true)
	{
		MDK_Error("InputMesh is empty @ DisplacementBasedPolygonMeshDeformer::CheckInput()")
		return false;
	}

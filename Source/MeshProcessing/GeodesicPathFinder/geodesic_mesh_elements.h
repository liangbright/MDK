...
public:
	...
	int_max size(){return m_size;};
	iterator begin(){return m_begin;};
	iterator end(){return m_begin + m_size;};

	template<class DataPointer>
	void set_allocation(DataPointer begin, int_max size)
	{
...
{
	int_max face_id;
	int_max vertex_0;		//adjacent vertices sorted by id value
	int_max vertex_1;		//they are sorted, vertex_0 < vertex_1
};

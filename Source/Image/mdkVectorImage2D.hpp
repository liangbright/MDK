#ifndef __mdkVectorImage2D_hpp
#define __mdkVectorImage2D_hpp
...
VectorImage2D<PixelType>::VectorImage2D()
: Image2D()
{
}
...
template<typename PixelType>
VectorImage2D<PixelType>::VectorImage2D(VectorImage2D<PixelType>&& InputImage)
: Image2D(std::forward<VectorImage2D<PixelType>&&>(InputImage))
{
}


template<typename PixelType>
void VectorImage2D<PixelType>::operator=(VectorImage2D<PixelType>&& InputImage)
{
    this->Image2D::operator=(std::forward<VectorImage2D<PixelType>&&>(InputImage));
}


template<typename PixelType>
VectorImage2D<PixelType> VectorImage2D<PixelType>::GetSubImage(int_max xIndex_s, int_max xIndex_e, int_max yIndex_s, int_max yIndex_e) const
{
    VectorImage2D<PixelType> tempImage; // empty image
...
template<typename PixelType>
VectorImage2D<PixelType> 
VectorImage2D<PixelType>::Pad(const std::string& Option, int_max Pad_Lx, int_max Pad_Ly) const
{
    VectorImage2D<PixelType> tempImage; // empty image
...
template<typename PixelType>
VectorImage2D<PixelType>
VectorImage2D<PixelType>::Pad(PixelType Pixel, int_max Pad_Lx, int_max Pad_Ly) const
{
    VectorImage2D<PixelType> tempImage; // empty image
...
template<typename PixelType>
VectorImage2D<PixelType> 
VectorImage2D<PixelType>::UnPad(int_max Pad_Lx, int_max Pad_Ly) const
{
    VectorImage2D<PixelType> tempImage; // empty image

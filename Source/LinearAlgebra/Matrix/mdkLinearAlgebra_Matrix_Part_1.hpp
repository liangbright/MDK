#ifndef mdk_LinearAlgebra_Part_1_hpp
#define mdk_LinearAlgebra_Part_1_hpp
...
template<typename ElementType>
inline
mdkMatrix<ElementType> MatrixLinearCombine(const std::vector<ElementType>& CoefList, 
...
template<typename ElementType>
inline 
bool MatrixLinearCombine(mdkMatrix<ElementType>& OutputMatrix, 

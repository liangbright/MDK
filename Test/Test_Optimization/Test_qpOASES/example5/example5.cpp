...
int main( )
{
	...
	MyConstraintProduct<double> myCP( 7,50,A );


	/* Setting up QProblem object and set construct product function. */
    QProblem<double> example(7, 50);
	...
	double g_in[7*n_rhs];
	double b_in[7*n_rhs];
	double bA_in[50*n_rhs];
	double x_out[7*n_rhs];
	double y_out[(7+50)*n_rhs];

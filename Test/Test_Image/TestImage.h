...
void testA()
{
	...
	auto a1 = ScalarImage_double.GetPixelAt3DContinuousIndex(1.0, 1.5, 1.0, Option);
	...
	auto b1 = ScalarImage_float.GetPixelAt3DContinuousIndex(1.0, 1.5, 1.0);
	...
	auto aa1 = ScalarImage_int.GetPixelAt3DContinuousIndex(1.0, 1.5, 1.0);
	...
	auto c1 = VectorImage_double.GetPixelAt3DContinuousIndex(1.0, 1.5, 1.0);
	...
	auto d1 = VectorImage_float.GetPixelAt3DContinuousIndex<float>(1.0, 1.5, 1.0);
	...
	//auto d = VectorImage_float.GetPixelAt3DContinuousIndex(1.0, 1.5, 1.0);
	...
	auto e1 = VectorImage_int.GetPixelAt3DContinuousIndex<int>(1.0, 1.5, 1.0);
}

...
void Test_0()
{
	...
	Remesher.BoundarySegmentListOfInputMesh.Resize(2);
	Remesher.BoundarySegmentListOfInputMesh[0] = UpperBoundary_template;
	Remesher.BoundarySegmentListOfInputMesh[1] = LowerBounary_template;
...
void test_hole()
{
	...
	Remesher.BoundarySegmentListOfInputMesh.Resize(3);
	Remesher.BoundarySegmentListOfInputMesh[0] = OuterBoundary_template;
	Remesher.BoundarySegmentListOfInputMesh[1] = InnerBounary_template;
	Remesher.BoundarySegmentListOfInputMesh[2] = LandMark_template;

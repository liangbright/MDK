...
clear
clc
candidateconflicttableTJunction=read_data('C:\Research\Mesh\Remeshing\TestData\candidate_conflict_table_TJunction.txt');
candidate_score=importdata('C:\Research\Mesh\Remeshing\TestData\candidate_score.txt');
CandidateIndexSetAtSmallTriangle=read_data('C:\Research\Mesh\Remeshing\TestData\CandidateIndexSet_At_SmallTriangle.txt');
CandidateIndexSetAtBigTriangle=read_data('C:\Research\Mesh\Remeshing\TestData\CandidateIndexSet_At_BigTriangle.txt');
%%

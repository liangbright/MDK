...
void Test_a1()
{
	...
	SurfaceRemesher6<double> Remesher;
	LoadTriangleMeshFromVTKFile(Remesher.m_InputMesh, TestDataPath + "inputmesh.vtk");
	Remesher.InitilizeCandidateMesh();
	Remesher.InitilizeSmallTriangleMesh();
	Remesher.GenerateCandidate();	
	Remesher.EvaluateCandidate();
	//Remesher.SelectCandidate_CoverTriangle();
	Remesher.SelectCandidate_RegionGrowing();
	Remesher.BuildMixedTriQuadMesh();
	SavePolygonMeshAsVTKFile(Remesher.m_CandidateMesh, TestDataPath + "candidate_mesh.vtk");
	SavePolygonMeshAsVTKFile(Remesher.m_SmallTriangleMesh, TestDataPath + "small_triangle_mesh.vtk");
	SavePolygonMeshAsVTKFile(Remesher.m_OutputMesh_Mixed, TestDataPath + "outputmesh_mixed_greedy.vtk");
...
void Test_a2()
{
	...
	Remesher.BuildMixedTriQuadMesh();
	SavePolygonMeshAsVTKFile(Remesher.m_OutputMesh_Mixed, TestDataPath + "outputmesh_mixed.vtk");
}
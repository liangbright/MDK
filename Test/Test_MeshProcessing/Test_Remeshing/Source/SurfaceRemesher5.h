...
class SurfaceRemesher5 : public Object
{
public:
...
//private:
	...
	bool Check_If_Candidate_is_Feasible(const DenseVector<int_max>& CandidateIndicatorList, int_max CandidateIndex);
...
private:
	SurfaceRemesher5(const SurfaceRemesher5&) = delete;
	void operator=(const SurfaceRemesher5&) = delete;
};

}//namespace

#include "SurfaceRemesher5.hpp"